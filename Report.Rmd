...
clade_plot <- 
  heatmap(clade_output,
          na.rm = TRUE,
          main = "Relationship Between Clades and Sample Genotypes")
...
vcf_with_metadata %>%
  ...
  knitr::kable(col.names = c("Gene Name",
                             "Count"))
```
***Table 2*** Complete count of SNPs detected in the samples provided. The majority of SNPs were located in non coding regions of the genome. 
...
gene_table %>%
  ...
  knitr::kable(col.names = c("Gene Name",
                             ...
                             "Length"))
```
**Table 4**: Gene names, locations, and lengths in the SARS-CoV-2 genome. Surprisingly, more distinct SNPs were detected in the N (nucleocapsid) gene, even though it is significantly smaller than the gene encoding the S (spike) protein. The nucleocapsid protien is thought to be involved in the efficiency of virion assembly. 
# Sources Cited
